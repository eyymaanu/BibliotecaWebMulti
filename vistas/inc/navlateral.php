			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<figcaption class="roboto-medium text-center">
						C.R.A <br><small class="roboto-condensed-light">Multi</small>
					</figcaption>
				</figure>
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						<li> 
							<a href="<?php echo SERVERURL?>./home/"><i class="fab fa-dashcube fa-fw"></i> &nbsp; Panel de Control</a>
						</li>
						...
						<li>
							<a href="#" class="nav-btn-submenu"><i class="fas fa-pallet fa-fw"></i> &nbsp; Libros <i class="fas fa-chevron-down"></i></a>
							<ul>
								<li>
									<a href="<?php echo SERVERURL ;?>./item-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar libros</a>
								</li>
								<li>
									<a href="<?php echo SERVERURL ;?>./item-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de Libros</a>
								</li>
								<li>
									<a href="<?php echo SERVERURL ;?>./item-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar libros</a>
								</li>
							</ul>
						</li>
